...
if (TYPE == 1 && SUBTYPE == 0)
{
    draw_sprite_ext(4204, 1, 43, 48, 2, 2, 0, 16777215, 0.03 + (sin(BG_SINER / 20) * 0.04));
    draw_sprite_ext(4204, 1, 47, 48, 2, 2, 0, 16777215, 0.03 + (sin(BG_SINER / 20) * 0.04));
    draw_sprite_ext(4204, 1, 43, 52, 2, 2, 0, 16777215, 0.03 + (sin(BG_SINER / 20) * 0.04));
    draw_sprite_ext(4204, 1, 47, 52, 2, 2, 0, 16777215, 0.03 + (sin(BG_SINER / 20) * 0.04));
    draw_sprite_ext(4204, 1, 45, 50, 2, 2, 0, 16777215, 0.25);
    BG_SINER++;
}
if (BGMADE == 1 && SUBTYPE == 1)
{
    ...
    for (i = 0; i < (__WAVEHEIGHT - 50); i += 1)
    {
        ...
        draw_background_part_ext(5157, 0, i, __WAVEWIDTH, 1, sin((i / 8) + (BG_SINER / 30)) * __WAVEMAG, (-10 + i) - (BG_ALPHA * 20), 1, 1, image_blend, BG_ALPHA * 0.8);
        draw_background_part_ext(5157, 0, i, __WAVEWIDTH, 1, -sin((i / 8) + (BG_SINER / 30)) * __WAVEMAG, (-10 + i) - (BG_ALPHA * 20), 1, 1, image_blend, BG_ALPHA * 0.8);
    }
    ...
    draw_sprite_ext(4818, ANIM_SINER / 12, 0, ((10 - (BG_ALPHA * 20)) + __WAVEHEIGHT) - 70, 1, 1, 0, image_blend, BG_ALPHA * 0.46);
    draw_sprite_ext(4818, (ANIM_SINER / 12) + 0.4, 0, ((10 - (BG_ALPHA * 20)) + __WAVEHEIGHT) - 70, 1, 1, 0, image_blend, BG_ALPHA * 0.56);
    draw_sprite_ext(4818, (ANIM_SINER / 12) + 0.8, 0, ((10 - (BG_ALPHA * 20)) + __WAVEHEIGHT) - 70, 1, 1, 0, image_blend, BG_ALPHA * 0.7);
}
if (MENU_NO >= 0)
{
    for (i = 0; i < 3; i += 1)
    {
        ...
        draw_sprite_ext(6488, 0, BOX_X1, BOX_Y1, XL, YL, 0, 0, 0.5);
        ...
        if (TYPE == 1)
        {
            ...
            draw_sprite_ext(6488, 0, BOX_X1 - 2, BOX_Y1 - 2, (BOX_X2 - BOX_X1) + 4, 2, 0, col, alf);
            draw_sprite_ext(6488, 0, BOX_X1 - 2, BOX_Y2, (BOX_X2 - BOX_X1) + 4, 2, 0, col, alf);
            draw_sprite_ext(6488, 0, BOX_X1 - 2, BOX_Y1 - 2, 2, (BOX_Y2 - BOX_Y1) + 4, 0, col, alf);
            draw_sprite_ext(6488, 0, BOX_X2, BOX_Y1 - 2, 2, (BOX_Y2 - BOX_Y1) + 4, 0, col, alf);
        }
...
if (MENU_NO >= 0)
{
    draw_sprite(4862, 0, HEARTXCUR, HEARTYCUR);
}
draw_set_font(6);
draw_set_color(16777215);
