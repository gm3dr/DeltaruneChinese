...
function scr_rhythmgame_draw_backing(arg0, arg1, arg2 = false, arg3 = 0)
{
    ...
    {
        draw_set_color(merge_color(0, 8421504, fade * brightness));
    }
    var _gray = merge_color(0, 8421504, brightness);
    draw_set_color(0);
    var _flash = 0;
    if (invc > 0 && fade == 1)
    {
    ...
    if (_flash > 0)
    {
        ...
        var _flashCol = merge_color(0, 255, _flash * fade * brightness);
...
function scr_rhythmgame_draw_chart(arg0, arg1, arg2 = false)
{
    ...
    {
        draw_sprite_ext(708, 4, arg1 - 20, bottomy, 1, 1, 0, _notecol[0], 1);
        draw_sprite_ext(708, 4, arg1 + 20, bottomy, 1, 1, 0, _notecol[1], 1);
    }
    if (instrument == 2)
    {
        draw_set_color(0);
    ...
    if (instrument == 2 && !arg2 && obj_rhythmgame.song_id != 10)
    {
        ...
        for (var i = 0; i < 3; i++)
        {
            ...
            {
                draw_sprite_ext(1657, 1, (arg1 - 30) + (30 * i), bottomy, _beam * 0.75, 1, 0, _gold, 1);
                draw_sprite_ext(1657, 2, (arg1 - 30) + (30 * i), bottomy, _beam * 0.75, 1, 0, _white, 1);
        ...
        if (cooldown > 0)
        {
            ...
            draw_sprite_ext(573, 0, (arg1 - 30) + (30 * last_note) + notex, bottomy + 3, 1, 1, 0, _arrow, clamp01(cooldown));
        ...
        for (var i = 0; i < 2; i++)
        {
            if (note_hit_timer[i] > 0)
            {
                ...
                if (instrument == 1)
                {
                    ...
                    draw_sprite_ext(708, 3, _cenx, bottomy, 1, 1, 0, _white, note_hit_timer[i] / 5);
                }
                if (instrument == 2)
                {
                    _cool = true;
                ...
                if (!arg2 && obj_rhythmgame.fame >= 12000 && _score > 0)
                {
                    if (instrument != 2)
                    {
                        draw_sprite_ext(4556, (1 - _beam) * 2.9, _cenx + (_side * (1 - _ease) * 2), bottomy, 2 - _beam, 2 - _beam, 0, merge_color(_white, _col, 1 - _ease), _ease);
                    }
                    else
                    {
                        var _beam_scale = 1 - _beam;
                        draw_sprite_ext(4516, (1 - _beam) * 2.9, _cenx, bottomy, (_beam_scale * 0.5) + 1, (_beam_scale * 0.5) + 1, 0, merge_color(_white, _col, 1 - _ease), _ease);
                    }
                }
                if (instrument == 2)
                {
                    var _beam_scale = 1 - _beam;
                    draw_sprite_ext(1657, 1, _cenx, bottomy, 2, _beam_scale + 0.25, 0, _gold, clamp01(_beam * 2));
                    draw_sprite_ext(1657, 2, _cenx, bottomy, 2, _beam_scale + 0.25, 0, _white, clamp01(_beam * 2));
                }
                else if (_cool)
                {
                    draw_sprite_ext(1657, 1, _cenx, bottomy, _beam, 1, 0, _gold, 1);
                    draw_sprite_ext(1657, 2, _cenx, bottomy, _beam, 1, 0, _white, 1);
                }
                else
                {
                    draw_sprite_ext(1657, 0, _cenx, bottomy, _beam, 1, 0, _white, 1);
                }
                note_hit_timer[i] -= _hitspeed;
            }
        }
        ...
        if (notey >= _topy && (notei >= minnote || _notescore <= 0 || (_loopcheck && _notealive)))
        {
            ...
            if (_notealive == 1 || _notescore <= 0)
            {
                ...
                if (arg2 && paused && do_refresh)
                {
                    ...
                    var _node = instance_create((_xleft - _xwidth) + (notetype[notei] * _xwidth) + 15, notey, 466);
                    _node.depth = depth + 1;
...
function scr_rhythmgame_draw_note(arg0, arg1, arg2, arg3 = 0)
{
    if (instrument == 2)
    {
        ...
        {
            draw_sprite_ext(3035, 0, arg0, arg1, 1, 1, 0, draw_get_color(), 1);
        }
    }
    ...
    else
    {
        ...
        draw_sprite_ext(1988, 0, arg0, arg1, 1, 1, 0, draw_get_color(), 1);
    }
}

function scr_rhythmgame_draw_note_clap(arg0, arg1, arg2, arg3 = 0)
{
    draw_sprite_ext(4355, 0, arg0, arg1, 1, 1, 0, draw_get_color(), 1);
}
...
function scr_rhythmgame_draw_note_long(arg0, arg1, arg2, arg3, arg4 = false)
{
    if (instrument == 2)
    {
        ...
        draw_sprite_ext(3035, 0, arg0, arg1 - arg3, 1, 1, 0, _col, 1);
        draw_sprite_ext(3035, 0, arg0, arg1, 1, 1, 0, _col, 1);
    }
    else
    {
        arg0 = (arg0 - 20) + (arg2 * 40);
    ...
    if (arg4)
    {
        ...
        if (instrument == 2)
        {
            ...
            draw_sprite_ext(3035, 0, arg0, arg1 - arg3, 1, 1, 0, _endColor, 1);
        }
