...
if (type == 3 && init == 1)
{
    if (menu == 0)
    {
        ...
        if (recruitSprite[menuCoord[0]] == 2050)
        {
            draw_sprite_ext(2122, 0, (xx + 470 + rx) - 20, (yy + 220 + ry) - 12, 2, 2, 0, 16777215, 1);
            draw_sprite_ext(2119, 0, (xx + 470 + rx) - 20, (yy + 220 + ry) - 12 - 31, 2, 8, 0, 16777215, 1);
        }
        draw_set_halign(1);
    ...
    if (menu == 1)
    {
        ...
        if (recruitSprite[menuCoord[1]] == 2050)
        {
            draw_sprite_ext(2122, 0, (xx + 180 + rx) - 20, (yy + 215 + ry) - 12, 2, 2, 0, 16777215, 1);
            draw_sprite_ext(2119, 0, (xx + 180 + rx) - 20, (yy + 215 + ry) - 12 - 31, 2, 8, 0, 16777215, 1);
        }
        draw_set_color(16777215);
