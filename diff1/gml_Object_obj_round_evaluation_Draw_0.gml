...
if (con == 0)
{
    ...
    repeat (6)
    {
        repeat (5)
        {
            draw_sprite_ext(1601, star_anim, (camerax() + (_x * 160) + bg_x_extra) - 0, (cameray() + (_y * 160) + bg_y) - 320, 2, 2, 0, 16777215, 1);
            _y++;
        }
        _x++;
        _y = 0;
    ...
    if (bg_y > -6)
    {
        ...
        {
            bouncecount++;
            snd_play_x(211, 1 - (bouncecount / 8), 1);
        }
        bouncebuff = 3;
    }
    if (timer >= 60)
...
if (con == 0.5)
{
    ...
    scr_draw_sprite_tiled_area(1601, star_anim, camerax() + bg_speed, cameray() + bg_speed_y, camerax() + bg_speed, cameray() + bg_speed_y, camerax() + view_wport[0], cameray() + room_height, 2, 2, 16777215, 1);
}
if (con >= 1)
{
    draw_set_alpha(1);
    ...
    if (replayversion && boardnumber == 3)
    {
        ...
        draw_sprite_ext(1022, 0, ((camerax() + 320 + shakeobj.x) - round((string_width(title) / 2) + 10)) + shadoff, yy + (mspace * 0) + 6 + shadoff, -80, 2, 0, shadcolor, shadalph);
        draw_sprite_ext(1022, 0, ((camerax() + 320 + shakeobj.x + round((string_width(title) / 2) + 10)) - 2) + shadoff, yy + (mspace * 0) + 6 + shadoff, 80, 2, 0, shadcolor, shadalph);
        draw_sprite_ext(1022, 0, (camerax() + 320 + shakeobj.x) - round((string_width(title) / 2) + 10), yy + (mspace * 0) + 6, -80, 2, 0, 16777215, 1);
        draw_sprite_ext(1022, 0, (camerax() + 320 + shakeobj.x + round((string_width(title) / 2) + 10)) - 2, yy + (mspace * 0) + 6, 80, 2, 0, 16777215, 1);
        draw_set_halign(0);
        var _col = 16777215;
        rcheckskip(1, 28);
        if (rtimer == 28)
    ...
    if (replayversion && boardnumber == 2)
    {
        ...
        draw_sprite_ext(1022, 0, (midx - round((string_width(title) / 2) + 10)) + shadoff, yy + (mspace * 0) + 6 + shadoff, -80, 2, 0, shadcolor, shadalph);
        draw_sprite_ext(1022, 0, ((midx + round((string_width(title) / 2) + 10)) - 2) + shadoff, yy + (mspace * 0) + 6 + shadoff, 80, 2, 0, shadcolor, shadalph);
        draw_sprite_ext(1022, 0, midx - round((string_width(title) / 2) + 10), yy + (mspace * 0) + 6, -80, 2, 0, 16777215, 1);
        draw_sprite_ext(1022, 0, (midx + round((string_width(title) / 2) + 10)) - 2, yy + (mspace * 0) + 6, 80, 2, 0, 16777215, 1);
        draw_set_halign(0);
        rcheckskip(1, 28);
        if (rtimer == 28)
        {
    ...
    if (!replayversion)
    {
        ...
        if (rtimer > 150 && con == 1)
        {
            ...
            {
                draw_sprite_ext(5023, 0, board_tilex(13), board_tiley(11.5) + _y_extra, 2, 2, 0, 16777215, 1);
            }
...
if (tv_vignette)
{
    draw_sprite_ext(4206, 0, camerax() + 124, cameray() + 48, 1, 1, 0, 16777215, tv_vignette_alpha);
}
if (white_overlay)
{
    draw_set_color(16777215);
