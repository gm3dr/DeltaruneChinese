...
for (n = 1; n < pos; n += 1)
{
    ...
    else if (mychar == "\\")
    {
        ...
        if (nextchar == "f" && faced == 0)
        {
            ...
            {
                global.sminstance[fam] = instance_create(global.smxx[fam], global.smyy[fam], 1026);
        ...
        if (nextchar == "*")
        {
            ...
            draw_sprite_ext(_sprite, 0, wx + x_offset, wy + 2 + y_offset, 2, 2, 0, 16777215, 1);
            if (_sprite == 3674)
            {
                wx += 8;
            }
            if (global.lang == "ja")
            {
                if (_sprite == 3802 || _sprite == 3803 || _sprite == 3798 || _sprite == 3799 || _sprite == 3788 || _sprite == 1707 || _sprite == 4475 || _sprite == 2956)
                {
                    wx += 4;
                }
            }
        ...
        if (nextchar == "C")
        {
            if (nextchar2 == "1")
            {
                if (instance_exists(1018) == false)
                {
                    choicer = instance_create(0, 0, 1018);
                }
                halt = 5;
            }
            if (nextchar2 == "2" || nextchar2 == "3" || nextchar2 == "4")
            {
                if (instance_exists(1019) == false)
                {
                    choicer = instance_create(0, 0, 1019);
    ...
    if (accept == 1)
    {
        ...
        if (special >= 1)
        {
            if (special == 1)
            {
                ...
                {
                    draw_text_color(wx + random(shake) + 1, wy + random(shake) + 1, mychar, 4210752, 4210752, 8388608, 8388608, 1);
