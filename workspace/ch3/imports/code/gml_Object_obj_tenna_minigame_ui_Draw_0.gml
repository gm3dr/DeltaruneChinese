...
{
    draw_text_transformed(camerax() + score_x + 140, ((cameray() + bar_y) - 5) + 70, "敌人", 3, 2, 0);
...
{
    draw_text_transformed(camerax() + score_x, (cameray() + bar_y) - 5, "敌人", 3, 2, 0);
...
draw_text_transformed(camerax() + score_x, cameray() + score_y, "得分", 3, 2, 0);
...
draw_text_transformed_color((camerax() + box_x) - 93, cameray() + box_y + 18, "失误", 3, 2, 0, blend1, blend1, blend1, blend1, 1);
