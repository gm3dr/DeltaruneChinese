...
{
    shakeobj = scr_marker_ext(0, 0, 6488);
    with (shakeobj)
    {
        visible = 0;
    }
...
var _norank = stringsetloc("NO RANK", "obj_round_evaluation_slash_Draw_0_gml_22_0_c");
...
if (con == 0)
{
    ...
    repeat (6)
    {
        repeat (5)
        {
            draw_sprite_ext(4962, star_anim, (camerax() + (_x * 160) + bg_x_extra) - 0, (cameray() + (_y * 160) + bg_y) - 320, 2, 2, 0, 16777215, 1);
            _y++;
        }
        _x++;
        _y = 0;
    ...
    if (bg_y > -6)
    {
        ...
        {
            bouncecount++;
            snd_play_x(311, 1 - (bouncecount / 8), 1);
        }
        bouncebuff = 3;
    }
    if (timer >= 60)
...
if (con == 0.5)
{
    ...
    scr_draw_sprite_tiled_area(4962, star_anim, camerax() + bg_speed, cameray() + bg_speed_y, camerax() + bg_speed, cameray() + bg_speed_y, camerax() + view_wport[0], cameray() + room_height, 2, 2, 16777215, 1);
}
if (con >= 1)
{
    draw_set_alpha(1);
    ...
    if (replayversion && boardnumber == 3)
    {
        ...
        draw_sprite_ext(6488, 0, ((camerax() + 320 + shakeobj.x) - round((string_width(title) / 2) + 10)) + shadoff, yy + (mspace * 0) + 6 + shadoff, -80, 2, 0, shadcolor, shadalph);
        draw_sprite_ext(6488, 0, ((camerax() + 320 + shakeobj.x + round((string_width(title) / 2) + 10)) - 2) + shadoff, yy + (mspace * 0) + 6 + shadoff, 80, 2, 0, shadcolor, shadalph);
        draw_sprite_ext(6488, 0, (camerax() + 320 + shakeobj.x) - round((string_width(title) / 2) + 10), yy + (mspace * 0) + 6, -80, 2, 0, 16777215, 1);
        draw_sprite_ext(6488, 0, (camerax() + 320 + shakeobj.x + round((string_width(title) / 2) + 10)) - 2, yy + (mspace * 0) + 6, 80, 2, 0, 16777215, 1);
        draw_set_halign(0);
        var _col = 16777215;
        rcheckskip(1, 28);
        if (rtimer == 28)
        ...
        if (gradecon >= 1)
        {
            ...
            draw_text_transformed_color(midx, yy + (mspace * 4) + 20, currentphysgrade, 4, 4, 0, _col, _col, 16777215, 16777215, 1);
        }
        if (gradecon >= 2)
        {
            reachedend_draw_triangle_siner += 0.3;
            var _flashcol = merge_color(16777215, 65535, 0.4 + (sin(reachedend_draw_triangle_siner) / 3));
            draw_set_halign(1);
    ...
    if (replayversion && boardnumber == 2)
    {
        ...
        draw_sprite_ext(6488, 0, (midx - round((string_width(title) / 2) + 10)) + shadoff, yy + (mspace * 0) + 6 + shadoff, -80, 2, 0, shadcolor, shadalph);
        draw_sprite_ext(6488, 0, ((midx + round((string_width(title) / 2) + 10)) - 2) + shadoff, yy + (mspace * 0) + 6 + shadoff, 80, 2, 0, shadcolor, shadalph);
        draw_sprite_ext(6488, 0, midx - round((string_width(title) / 2) + 10), yy + (mspace * 0) + 6, -80, 2, 0, 16777215, 1);
        draw_sprite_ext(6488, 0, (midx + round((string_width(title) / 2) + 10)) - 2, yy + (mspace * 0) + 6, 80, 2, 0, 16777215, 1);
        draw_set_halign(0);
        rcheckskip(1, 28);
        if (rtimer == 28)
        {
        ...
        if (gradecon >= 1)
        {
            ...
            draw_text_transformed_color(320, yy + (mspace * 6) + 10, currentphysgrade, 3, 3, 0, _col, _col, 16777215, 16777215, 1);
        }
        if (gradecon >= 2)
        {
            reachedend_draw_triangle_siner += 0.3;
    ...
    if (replayversion && boardnumber == 1)
    {
        ...
        if (gradecon >= 1)
        {
            ...
            draw_text_transformed_color(midx, yy + (mspace * 5.5), currentphysgrade, 3, 3, 0, 65535, 65535, 16777215, 16777215, 1);
            draw_set_halign(0);
        }
        if (gradecon >= 2)
        {
    ...
    if (!replayversion)
    {
        ...
        if (rtimer > 140)
        {
            ...
            draw_set_alpha(1);
            var col = 65535;
            draw_text_transformed_color(midx, yy + (mspace * 7) + 36, rankstring + "!!", 2, 2, 0, col, col, 16777215, 16777215, 1);
            draw_set_color(16777215);
        }
        draw_set_halign(0);
        if (rtimer > 150 && con == 1)
        {
            ...
            {
                draw_sprite_ext(5293, 0, board_tilex(13), board_tiley(11.5) + _y_extra, 2, 2, 0, 16777215, 1);
            }
...
if (tv_vignette)
{
    draw_sprite_ext(spr_dw_gameshow_screen_vignette, 0, camerax() + 124, cameray() + 48, 1, 1, 0, 16777215, tv_vignette_alpha);
}
if (white_overlay)
{
    draw_set_color(16777215);
...
if (scr_debug() && keyboard_check_pressed(80))
{
    con = 0;
    timer = 0;
    rtimer = 0;
