if (myself == 1)
{
    if (pipisSignAlpha > 0)
    {
        ...
        draw_sprite_ext((global.names >= 2 ? spr_zhname_pipissign : spr_pipissign), lang, (x - 4) + random_range(0, 1), y + (sprite_height / 2) + 12 + random_range(0, 1), 1, 1, 0, c_white, pipisSignAlpha);
    }
}
