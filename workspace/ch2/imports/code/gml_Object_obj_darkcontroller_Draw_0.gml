...
if (global.menuno == 4)
{
    ...
    if (charcoord == 2)
    {
        ...
        if (global.chapter == 1)
        {
            ...
            draw_text_transformed(xx + 100, ch_y[4], string_hash_to_newline(stringsetloc("Crudeness ", "obj_darkcontroller_slash_Draw_0_gml_252_0")), 1, 1, 0);
        ...
        if (global.chapter == 2)
        {
            draw_text_transformed(xx + 100, ch_y[4], string_hash_to_newline(stringsetloc("Purple ", "obj_darkcontroller_slash_Draw_0_gml_311_0")), 1, 1, 0);
            draw_item_icon(xx + 74, ch_y[4] + 6, 13);
