...
if (type == 2 && init == 1)
{
    ...
    var topbary = 206;
    d_rectangle(xx + 110, yy + topbary, (xx + 640) - 110, yy + topbary + 2, 0);
}
if (type == 1 && init == 1)
{
    draw_set_color(16777215);
    var topbary = 179;
    var botbary = 278;
    d_rectangle((xx + 110) - 20, yy + topbary, ((xx + 640) - 110) + 20, yy + topbary + 2, 0);
    d_rectangle((xx + 110) - 20, yy + botbary, ((xx + 640) - 110) + 20, yy + botbary + 2, 0);
    draw_set_halign(2);
    if (global.lang == "ja")
    {
        draw_text_transformed(((xx + 640) - 110) + 20 + 40, (yy + 280 + 20 + 60) - 14, string((floor(menuScrollCurrent[0]) / 2) + 1) + " / " + string(ceil(menuMaximumID[0] / 2) + 1), 0.5, 1, 0);
    }
    else
    {
        draw_text_transformed(((xx + 640) - 110) + 20 + 40, (yy + 280 + 20 + 60) - 14, stringsetloc("Page ", "obj_fusionmenu_slash_Draw_0_gml_171_0") + string((floor(menuScrollCurrent[0]) / 2) + 1) + " / " + string(ceil(menuMaximumID[0] / 2) + 1), 0.5, 1, 0);
    }
    draw_set_halign(0);
}
if (type == 3 && init == 1)
{
    if (menu == 0)
    {
        ...
        if (alternateMenu == 0)
        {
            d_rectangle(xx + 330, yy + 10, xx + 620, yy + 440, false);
            draw_set_color(0);
            d_rectangle(xx + 334, yy + 14, (xx + 620) - 4, (yy + 440) - 4, false);
        }
        reccolor = 0;
        ...
        if (recruitChapter[menuCoord[0]] == 5)
        {
            reccolor = 65535;
        }
        d_rectangle_color(xx + 370, yy + 75, xx + 370 + 205, yy + 75 + 150, 0, 0, reccolor, reccolor, false);
        draw_set_color(16777215);
        d_rectangle(xx + 370, yy + 75, xx + 370 + 205, yy + 75 + 150, true);
        ...
        animer += 0.25;
        draw_sprite_ext(recruitSprite[menuCoord[0]], animer, xx + 470 + rx, yy + 220 + ry, 2, 2, 0, 16777215, 1);
        if (recruitSprite[menuCoord[0]] == 2951)
        {
            draw_sprite_ext(3034, 0, (xx + 470 + rx) - 20, (yy + 220 + ry) - 12, 2, 2, 0, 16777215, 1);
            draw_sprite_ext(3033, 0, (xx + 470 + rx) - 20, (yy + 220 + ry) - 12 - 31, 2, 8, 0, 16777215, 1);
        }
        draw_set_halign(1);
        ...
        if (alternateMenu == 0)
        {
            ...
            {
                draw_sprite_ext(scr_getbuttonsprite(global.input_g[4], false), 0, xx + 380, yy + 323, 2, 2, 0, 16777215, 1);
                draw_sprite_ext(scr_getbuttonsprite(global.input_g[5], false), 0, xx + 380, yy + 353, 2, 2, 0, 16777215, 1);
    ...
    if (menu == 1)
    {
        ...
        if (recruitChapter[menuCoord[1]] == 5)
        {
            reccolor = 65535;
        }
        d_rectangle_color(xx + 80, yy + 70, xx + 80 + 205, yy + 70 + 150, 0, 0, reccolor, reccolor, false);
        draw_set_color(16777215);
        d_rectangle(xx + 80, yy + 70, xx + 80 + 205, yy + 70 + 150, true);
        ...
        animer += 0.25;
        draw_sprite_ext(recruitSprite[menuCoord[1]], animer, xx + 180 + rx, yy + 215 + ry, 2, 2, 0, 16777215, 1);
        if (recruitSprite[menuCoord[1]] == 2951)
        {
            draw_sprite_ext(3034, 0, (xx + 180 + rx) - 20, (yy + 215 + ry) - 12, 2, 2, 0, 16777215, 1);
            draw_sprite_ext(3033, 0, (xx + 180 + rx) - 20, (yy + 215 + ry) - 12 - 31, 2, 8, 0, 16777215, 1);
        }
        draw_set_color(16777215);
        ...
        stringl[2] = stringsetloc("WISH", "obj_fusionmenu_slash_Draw_0_gml_185_0");
        ...
        stringm[2] = recruitWish[menuCoord[1]];
        ...
        if (alternateMenu == 0)
        {
            if (recruitPlaceable[menuCoord[1]])
            {
                if (global.is_console || obj_gamecontroller.gamepad_active)
                {
                    draw_sprite_ext(scr_getbuttonsprite(global.input_g[4], false), 0, xx + 80, yy + 402, 2, 2, 0, 16777215, 1);
            ...
            if (global.is_console || obj_gamecontroller.gamepad_active)
            {
                draw_sprite_ext(scr_getbuttonsprite(global.input_g[5], false), 0, xx + 320, yy + 402, 2, 2, 0, 16777215, 1);
        ...
        else if (global.is_console || obj_gamecontroller.gamepad_active)
        {
            ...
            draw_sprite_ext(scr_getbuttonsprite(global.input_g[5], false), 0, button_x, yy + 402, 2, 2, 0, 16777215, 1);
