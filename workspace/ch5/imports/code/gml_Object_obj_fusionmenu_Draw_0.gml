...
if (type == 1 && init == 1)
{
    ...
    if (global.lang == "ja")
        ...
        draw_text_transformed(((xx + 640) - 110) + 20 + 40, (yy + 280 + 20 + 60) - 14, stringsetloc("Page ", "obj_fusionmenu_slash_Draw_0_gml_171_0") + string((floor(menuScrollCurrent[0]) / 2) + 1) + " / " + string(ceil(menuMaximumID[0] / 2) + 1), 1, 1, 0);
