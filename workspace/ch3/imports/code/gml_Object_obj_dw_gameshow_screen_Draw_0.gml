...
if (screen_state == "round_complete_2")
{
    ...
    draw_text_transformed_color(xx + shadoff, yy + shadoff + mspace, roundcompletetext15, 1, 1, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
    draw_set_color(c_white);
    draw_text(xx, yy, roundcompletetext1);
    draw_text(xx, yy + mspace, roundcompletetext15);
    draw_set_color(c_white);
    
    if (screen_sub_state == "bonus_board")
    {
        draw_set_halign(fa_center);
        draw_text_transformed_color(xx + shadoff, yy + mspace * 2 + shadoff, text_bonus_round, 1, 1, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
        ...
        if (!sprite_exists(bonus_sprite))
        {
            ...
            draw_set_halign(fa_left);
            draw_set_valign(fa_top);
            draw_text_transformed(xx, yy + mspace * 2, text_bonus_round, 1, 1, 0);
        ...
        var _col = merge_color(c_white, c_yellow, abs(sin(custom_text_timer / coltime)));
        var _col2 = merge_color(c_yellow, c_white, abs(sin((custom_text_timer + (coltime / 2)) / coltime)));
        draw_text_transformed_color(xx + shadoff, yy + mspace * 3 + shadoff, text_round + " 3", 2, 2, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
        draw_text_transformed_color(xx, yy + mspace * 3, text_round + " 3", 2, 2, 0, _col2, _col, _col2, _col, 1);
    ...
    {
        draw_set_halign(fa_center);
        draw_text_transformed_color(xx + shadoff, yy + mspace * 2 + shadoff, rank_text + " !!", 2, 2, 0, shadcolor, shadcolor, shadcolor, shadcolor, shadalph);
        draw_text_transformed_color(xx, yy + mspace * 2, rank_text + " !!", 2, 2, 0, c_yellow, c_yellow, c_white, c_white, 1);
        draw_set_halign(fa_left);
    }
...
if (screen_state == "board_bonus_bonus")
{
    if (!sprite_exists(bonus_confirmed_sprite))
    {
        ...
        draw_text_transformed(x, y + mspace, text_bonus_round, 1.6, 1.3, 0);
        draw_text_transformed(x, y + mspace * 2, text_confirmed, 1.6, 1.3, 0);
