...
COL_A = 32768;
COL_B = 65280;
COL_PLUS = merge_color(65280, 16777215, 0.5);
jamod = 0;
if (TYPE == 1)
{
    BGSINER = 0;
    BGMAGNITUDE = 6;
    COL_A = merge_color(12632256, 8388608, 0.2);
    COL_B = 16777215;
    COL_PLUS = merge_color(65535, 16777215, 0.5);
    BGMADE = 1;
    BG_ALPHA = 0;
    ANIM_SINER = 0;
    ANIM_SINER_B = 0;
    ...
    if (SUBTYPE == 0)
    {
        COL_A = merge_color(12632256, 128, 0.2);
        COL_B = 16777215;
        COL_PLUS = merge_color(65535, 16777215, 0.4);
        BGMADE = 0;
    }
}
MENU_NO = 0;
